#ifndef GAME_READY_REQUEST_H
#define GAME_READY_REQUEST_H
...
class GameReadyRequest: public Message {
private:
    MessageType message_type = MessageType::GameReadyRequest;

public:
    GameReadyRequest() = default;
